        ...
        <table class="col-12 table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="idLSP" id="idLSP" value="${requestScope["sanPham"].getIdLSP()}"></td>
                    ...
                    <td><input type="date" name="dateSP" id="dateSP" value="${requestScope["sanPham"].getNgaynhapSP()}"></td>
                    <td><input type="text" name="imgSP" id="imgSP" value="${requestScope["sanPham"].getImg()}"></td>
