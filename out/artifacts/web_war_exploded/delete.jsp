...
<form method="post">
    <table class="col-12 table table-striped">
        ...
        <tr>
            <td>${requestScope["sanPham"].getIdSP()}</td>
            <td>${requestScope["sanPham"].getIdLSP()}</td>
            <td>${requestScope["sanPham"].getNameSP()}</td>
            <td>${requestScope["sanPham"].getGiaSP()}</td>
            <td>${requestScope["sanPham"].getNgaynhapSP()}</td>
            <td><img src="${requestScope["sanPham"].getImg()}" height="50" width="50"/></td>
